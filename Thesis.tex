...
\begin{document} 
	\includepdf[pages=-,pagecommand={},width=\paperwidth]{titul.pdf}
	\maketitle
	\begin{abstract}
...
\begin{figure}[H]
	...
	\draw [fill = black] (0, 0) rectangle (6.5, 0.03);
	\draw (6.5, -0.4) node[color=red]{$B$};
	\draw (0, 0.34) node[]{$0$};
	\draw (6.5, 0.34) node[]{$1$};
	\draw (-0.05, -0.4) node[color=blue]{$A$};
	\draw (3.25, -0.47) node[]{$\frac{1}{2}$};
	\draw (3.65, -0.4) node[]{$\hat{x}$};
	\draw (4.46, -0.4) node[]{ $x_0$};
	\draw [fill = black] (0, -0.1) rectangle (0.02, 0.12);
	\draw [fill = black] (3.24, -0.1) rectangle (3.26, 0.12);
	\draw [fill = black] (6.48, -0.1) rectangle (6.5, 0.12);
	\draw [fill = black] (3.64, -0.1) rectangle (3.66, 0.12);
	\draw [fill = black] (4.45, -0.1) rectangle (4.47, 0.12);
	\draw[pattern=north west lines, pattern color=blue] (0,0) rectangle (3.64,0.2);
	\draw[pattern=north west lines, pattern color=red] (3.66,0) rectangle (6.48,0.2);
	\draw[pattern=north west lines, pattern color=blue] (0,0) rectangle (4.45,-0.2);
	\draw[pattern=north west lines, pattern color=red] (4.47,0) rectangle (6.48,-0.2);
	\draw [dashed] (3.65,0) -- (3.65,0.7);
	\draw [dashed] (4.46,0) -- (4.46,0.7);
	\draw [<->] (3.65,0.7) -- (4.46,0.7);
	\draw (4.05, 0.9) node[]{$\Delta$};
	\end{tikzpicture}
